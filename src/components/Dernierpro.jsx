...
export default function Dernierpro(){
    ...
    <section className="section-dernier">
      <div className="service-div">
        <h1  style={{fontSize:"50px", fontWeight:"bold", color:"white",  fontFamily: 'Poppins',
}} className="dernier"> <i className="fa-solid fa-list-check" style={{paddingRight :"10px", fontSize:"80%"}}></i> Derniere projet</h1>
      <section>
